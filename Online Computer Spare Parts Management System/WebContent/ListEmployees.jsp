...
<%@page import="com.employee.service.EmployeeServiceImpl"%>
<%@page import="com.employee.service.IEmployeeService"%>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp">
					<img src="images/6.png" width="150px" height="50px" alt="LOGO">
				</a>
			</div>
			<!-- Top Menu Items -->
										...
										<div>
											<form method="POST" action="GetEmployeeServlet">
												<input type="hidden" name="employeeID"
													value="<%String id = employee.getEmployeeID();%>" />
												<button type="submit" name="employeeID2"
													class="btn btn-primary" value="Select Employee">Select
													Employee</button>
											</form>
										</div>
										<div>
											<form method="POST" action="DeleteEmployeeServlet">
												<input type="hidden" name="employeeID2"
