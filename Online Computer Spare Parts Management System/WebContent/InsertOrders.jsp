        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    ...
                    <form method="POST" action="AddOrdersServlet">
					  ...
					  <button type="submit" class="btn btn-primary" value="Add Orders" >Submit</button>
					  <button type="reset" class="btn btn-danger" value="Reset" >Reset</button>
					</form>
					<br>
					<div >
						<form method="POST" action="ListOrdersServlet">
						<table>
							
								<button type="submit" class="btn btn-success" value="List All Employees" >List All Orders</button>
