					...
					<div class="col-sm-12 col-md-12 well" id="content">
						...
						<form method="POST" action="UpdateSupplierServlet">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="supplierID"
										value="<%=supplier.getSupplierID()%>" disabled="disabled">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input value="<%=supplier.getSupplierName()%>" type="text"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input value="<%=supplier.getCompanyName()%>" type="text"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input value="<%=supplier.getContactNo()%>" type="number"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input value="<%=supplier.getAddress()%>" type="text"
							...
							<div class="form-group row">
								<label class="col-sm-2 col-form-label">Supplier Type</label>
								<div class="col-sm-10">
									
										<select  value="<%=supplier.getTypes()%>" class="form-control" name="type">
							...
							<button type="update" class="btn btn-primary" name="supplierID"
								value="<%=supplier.getSupplierID()%>">Update</button>
						</form>
						<form method="POST" action="DeleteSupplierServlet">
							<button type="submit" class="btn btn-primary" name="supplierID"
								value="<%=supplier.getSupplierID()%>">Delete</button>
						</form>
						<br>
						<div></div>
