					...
					<div class="col-sm-12 col-md-12 well" id="content">
						...
						<form method="POST" action="UpdateOrdersServlet">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="ordersID"
										value="<%=orders.getOrdersID()%>"  disabled="disabled">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input value="<%=orders.getCustomername()%>" type="text"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
										<input value="<%=orders.getProductid()%>" type="text"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
										<input value="<%=orders.getQuantity()%>" type="text"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
										<input value="<%=orders.getPrice()%>" type="text"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
										<input value="<%=orders.getTotal()%>" type="number"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
										<input value="<%=orders.getDate()%>" type="text"
							...
							<button type="update" class="update-button"
								value="<%=orders.getOrdersID()%>">Update</button>
						</form>
						<form method="POST" action="DeleteEmployeeServlet">
							<button type="submit" class="btn btn-primary" name="ordersID"
								value="<%=orders.getOrdersID()%>">Delete</button>
						</form>
						<br>
						<div></div>
