					...
					<div class="col-sm-12 col-md-12 well" id="content">
						...
						<form method="POST" action="AddEmployeeServlet">
							...
							<button type="submit" class="btn btn-primary"
								value="Add Employee">Submit</button>
							<button type="reset" class="btn btn-danger" value="Reset">reset-button</button>
						</form>
						<br>
						<div>
							<form method="POST" action="ListEmployeeServlet">
								<table>
									...
									<button type="submit" class="btn btn-success"
										value="List All Employees">List All Employees</button>
